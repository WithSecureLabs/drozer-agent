...
import com.WithSecure.jsolar.api.connectors.Connector.Status;
import com.WithSecure.jsolar.api.connectors.Endpoint.EndpointSerializer;
...
public class EndpointManager extends SQLiteOpenHelper {
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		if(oldVersion <= 1) {
			...
			db.execSQL("ALTER TABLE " + TABLE_NAME + " ADD " + SSL_TRUSTSTORE_PATH_COLUMN + " varchar(255) DEFAULT '' NOT NULL");
