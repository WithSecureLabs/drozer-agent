...
import com.WithSecure.jsolar.api.links.Server;
...
public class ServerService extends ConnectorService {
	...
	private com.WithSecure.jsolar.api.connectors.Server server_parameters = new com.WithSecure.jsolar.api.connectors.Server();
	
	public Bundle getDetailedStatus() {
		Bundle data = new Bundle();
		
		data.putBoolean(Connector.CONNECTOR_ENABLED, server_parameters.isEnabled());
		data.putBoolean(com.WithSecure.jsolar.api.connectors.Server.SERVER_PASSWORD, server_parameters.hasPassword());
    	data.putBoolean(com.WithSecure.jsolar.api.connectors.Server.SERVER_SSL, server_parameters.isSSL());
	...
	public int onStartCommand(Intent intent, int flags, int startId){
		...
		if(intent != null && intent.getCategories() != null && intent.getCategories().contains("com.WithSecure.dz.START_EMBEDDED")) {
