...
import com.WithSecure.jsolar.api.Protobuf.Message.Primitive;
...
public class ReflectedPrimitive extends ReflectedType {
	...
	public Object getNative() {
		Log.i("Reflected Primitive", "Value: " + this.value);
		Log.i("Reflected Primtiive", "WrapperClass: " + this.getWrapperClass().getName());
		Log.i("Reflected Primitive", "Casted: " + this.getWrapperClass().cast(this.value));
